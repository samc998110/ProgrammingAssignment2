## The makeCacheMatrix function creates a list of function which are anchored in an environment (the environment 
## during execution of makeCacheMatrix). When these functions are later called 
...
##prior data saved to "i", then sovle the input matrix and save the solution to 
